...
//! Plain text editor with scroll management.
//!
//! Scroll tracking uses two components:
//! - Discrete line number
//! - Continuous vertical pixel offset
...
use parley::{BoundingBox, FontContext, LayoutContext, StyleProperty, StyleSet};
...
///
/// Follows the cosmic-text pattern: discrete line + continuous vertical offset.
#[derive(Debug, Clone, Copy, PartialEq, Default)]
pub struct Scroll {
    /// The index of the line at the top of the viewport.
    pub line: usize,
    /// Vertical offset in pixels from the start of that line.
    pub vertical: f32,
}
    ...
    T: Brush + Clone + Debug + PartialEq + Default,
{
    ...
    /// Current scroll state (line + vertical offset).
    scroll: Scroll,
